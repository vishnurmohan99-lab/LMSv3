...
export default function FacultyNotesBankDetailPage() {
  ...
  return (
    <main className="fade-in" style={{ padding: "30px 40px 60px" }}>
      <Link href="/faculty/notes" style={{ fontSize: 12.5, fontWeight: 700, color: "var(--ink3)" }}>← Faculty Notes</Link>
